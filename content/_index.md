...
*Learning how the world works through data.*

I'm a data scientist with a research background in computational biology. I like asking questions, digging through messy data for the answers, and building things that make them fun to explore.
...
- [Nom or Not](https://nom-or-not.vercel.app/) — a web app for tracking whether your cats actually eat
- [BoardGameFinder](https://huggingface.co/spaces/yueyvettehao/BoardGameFinder) — a RAG-based conversational board game recommender
- [Data Viz Portfolio](https://datavizgallery-yuehao.streamlit.app/) — a gallery of interactive data visualizations


## Profiles

- [LinkedIn](https://www.linkedin.com/in/yuehao/)
- [GitHub](https://github.com/YueYvetteHao)
- [Hugging Face](https://huggingface.co/yueyvettehao)
- [Credly](https://www.credly.com/users/yueyvettehao/skills)

## Scholarly activities

- [Google Scholar](https://scholar.google.com/citations?user=Yf8nU2YAAAAJ&hl=en)
